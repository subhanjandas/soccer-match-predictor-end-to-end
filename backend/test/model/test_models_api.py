# backend/test/model/test_models_api.py
...
class TestModelsApi(TestCase):
    ...
    def setUp(self) -> None:
        super().setUp()
        self.maxDiff = None  # Show full diff in error messages
    ...
    def test_list_models(self) -> None:
        ...
        # Print the actual JSON response to verify
        ...
        self.assertEqual(response.get_json(), {'models': [
            ...
            {"name": "Alphabet Predictor", "predicts_in_progress": False},
            {"name": "Advanced Predictor", "predicts_in_progress": False},
        ]})
